<template>
  <main>
    ...
    <ServicesHero
      ...
      :button-link="schedulingLinks.newBankruptcyClient"
      backgroundImage="/img/helpinghand_1024_o20.png"
    />
...
const bankruptcyOptions = [
  ...
  },
  {
    ...
    description: `Sometimes bankruptcy isn't the best solution:`,
    features: [
      ...
      { text: `We'll provide an honest assessment of all your debt relief options` }
    ]
  }
]
